...
questionsArray=[
    ...
    // },
    {
        ...
        name: 'licence',
        choices:['None','Apache Licence 2.0', 'GNU General Public Licence v3.0','MIT Licence','BSD 2-Clause "Simplified" Licence','Eclipse Public Licence 2.0','Mozilla Public Licence'],
    },
    {   type: 'confirm',
         message: 'Your licence badge will be displayed next to your project',
         name: 'badge',
   },
